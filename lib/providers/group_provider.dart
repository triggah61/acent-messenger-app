...
class GroupProvider with ChangeNotifier {
      ...
      if (response.statusCode == 200) {
        ...
        for (var doc in docs) {
          try {
            ...
            print(
                "GroupProvider - fetchSessions: Error parsing session ${doc['_id']} - $e");
            print(
                "GroupProvider - fetchSessions: Problematic session data: $doc");
  ...
  void updateSessionWithNewMessage(Map<String, dynamic> messageData) {
    try {
      ...
      print(
          "GroupProvider - updateSessionWithNewMessage: Message data keys: ${messageData.keys.toList()}");
      ...
      print(
          "GroupProvider - updateSessionWithNewMessage: Extracted chatSessionId: $chatSessionId");

      if (chatSessionId == null || chatSessionId.isEmpty) {
        print(
            "GroupProvider - updateSessionWithNewMessage: No valid chatSessionId found");
        return;
      }
  ...
  void _updateExistingSession(
    ...
    try {
      ...
      print(
          "GroupProvider - _updateExistingSession: Error updating session - $e");
      print(
          "GroupProvider - _updateExistingSession: Message data keys: ${messageData.keys.toList()}");
